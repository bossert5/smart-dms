...
- Disabled llama.cpp thinking for non-reasoning metadata steps and added a dedicated diagnostic category when reasoning exhausts the output token budget.
